...
function typeWriter(text, i) {
    if (i < text.length) {
        ...
        setTimeout(function () {
            ...
            typeWriter(text, i);
        }, 100); // Atur kecepatan pengetikan di sini (dalam milidetik)
    } else {
        ...
        setTimeout(function () {
            ...
            typeWriter(text, 0);
        }, 1000); // Waktu jeda sebelum memulai ulang animasi (dalam milidetik)
    }
}
...
window.onload = function () {
    ...
    typeWriter("Student | Graphic Designer", 0);
};
